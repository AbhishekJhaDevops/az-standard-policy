...
foreach ($env in $environments) {
    try {
        ...
        Write-Host "Could not create environment '$env' automatically. Please create manually." -ForegroundColor Yellow
    }
}
...
Write-Host ""
Write-Host "Setup completed! You can now use the GitHub Actions workflows." -ForegroundColor Green